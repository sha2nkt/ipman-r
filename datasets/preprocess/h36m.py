...
def h36m_extract(dataset_path, out_path, protocol=1, extract_img=False, vis_path=None, visualize=False):
    ...
    # structs we use
    imgnames_, scales_, centers_, parts_, Ss_, Ss_world_,  = [], [], [], [], [], []
    ...
    for user_i in user_list:
        ...
        ## path with mosh data - there is no mosh for test sequences
