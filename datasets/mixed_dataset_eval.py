...
from .base_dataset_eval import BaseDatasetEval

class MixedDatasetEval(torch.utils.data.Dataset):
    ...
    def __init__(self, options, **kwargs):
        ...
        self.datasets = [BaseDatasetEval(options, ds, **kwargs) for ds in self.dataset_list]
