...
class TrainOptions():
    ...
    def __init__(self):
        ...
        train.add_argument("--cop_w", type=float, default=10, help="pressure term for outside vertices in center of support computation")
        train.add_argument("--cop_k", type=float, default=100, help="pressure term/spring constant for inside vertices in center of support computation")
        train.add_argument("--in_alpha1", type=float, default=1,
                           help="alpha1 constant for the inside push term")
        train.add_argument("--in_alpha2", type=float, default=0.5,
                           help="alpha2 constant for the inside push term")
        train.add_argument("--out_alpha1", type=float, default=1,
                           help="alpha1 constant for the outside pull term")
        train.add_argument("--out_alpha2", type=float, default=0.15,
                           help="alpha2 constant for the outside pull term")
        train.add_argument("--contact_thresh", type=float, default=0.1,
                           help="threshold for contact")
        ...
        train.add_argument('--run_eval', default=False, action='store_true', help='Runs everytime model checkpoint is saved on disk')
        ...
        train.add_argument('--is_agora', default=False, action='store_true', help='Enable AGORA supervised training')
        train.add_argument('--is_others', default=False, action='store_true', help='Enable SMPLIFY training with other SPIN dataset except for H36M')
        ...
        train.add_argument('--stability_loss_weight', default=1., type=float, help='Weight for the stability loss')
        train.add_argument('--inside_push_loss_weight', default=1., type=float, help='Weight for the push term in ground intersection loss')
        train.add_argument('--outside_pull_loss_weight', default=1., type=float, help='Weight for the pull term in ground intersection loss')
